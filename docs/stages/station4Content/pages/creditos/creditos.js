class station4ContentClass_creditos extends generalPage{
  ...
  content(){
      ...
      <div class="text-center">
        <button class="btn-general" onclick="stages_station4Content.menu.back()">Atrás</button>
      </div>
      `;
  }
  importCssFiles(){
...
stagePage.pageContainerSet('creditos',station4ContentClass_creditos);